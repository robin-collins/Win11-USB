...
Describe 'Get-RehearsalStandardScenarioOverlay' {
    It 'returns the exact T10 Standard baseline described in FABLE_TASKS.md' {
        ...
        $overlay.ContainsKey('wipe_minimum_target_disk_gb') | Should -BeFalse -Because 'the absolute size floor was replaced by OSIT-DiskCheck.cmd''s relative-size check and needs no rehearsal override'
